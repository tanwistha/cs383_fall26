...
| 1 | Sep 4 | Linear search; binary search | TBD | PA1 released |
| 2 | Sep 7 | Labor Day - No class | - | - |
| 2 | Sep 9 | Asymptotic Notation (Big-O); runtime and growth rate | TBD | - |
| 2 | Sep 11 | Flex | TBD | PA1 due |
| 3 | Sep 14 | Sorting (Selection and Insertion) | TBD | PA2 released | 
| 3 | Sep 16 | Divide and Conquer; Mergesort | TBD | - |
| 3 | Sep 18 | Mergesort (contd.); Quicksort (intro) | TBD | - |
| 4 | Sep 21 | Quicksort; partition, pivot | TBD | - |
| 4 | Sep 23 | Sorting (conclusion); Selection; Median | TBD | - | 
| 4 | Sep 25 | Flex | TBD | PA2 due |
| 5 | Sep 28 | Priority queues; Heaps | TBD | PA3 released |
