...
- Please check the attendance requirement for the first two weeks of classes (i.e. during add/drop period) [as defined by registrar's office here](https://college.lclark.edu/offices/registrar/Faculty/attendance-how-to-request-that-a-non-attending-student-be-dropped/) and make sure you do not miss the first few lectures if you intend to continue with this course.
